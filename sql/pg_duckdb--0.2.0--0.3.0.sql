...
CREATE FUNCTION duckdb_get_row_field_operator(duckdb.row, text) RETURNS duckdb.unresolved_type AS 'MODULE_PATHNAME', 'duckdb_get_row_field_operator' LANGUAGE C IMMUTABLE STRICT;

-- TODO: Remove this probably
CREATE OPERATOR -> (
    LEFTARG = duckdb.row,
    RIGHTARG = TEXT,
    FUNCTION = duckdb_get_row_field_operator
);
