 ...
 */
static HTSV_Result
PgDuckDB_HeapTupleSatisfiesVacuumHorizon(HeapTuple htup, Buffer buffer, TransactionId *dead_after)
{
	HeapTupleHeader tuple = htup->t_data;
								...
								Buffer buffer)
{
	...
	res = PgDuckDB_HeapTupleSatisfiesVacuumHorizon(htup, buffer, &dead_after);
 ...
 */
bool
HeapTupleSatisfiesVisibilityNoHintBits(HeapTuple htup, Snapshot snapshot, Buffer buffer)
{
