...
Once loaded, DuckDB is used to execute all SELECT queries in Postgres. Query as usual. You can disable DuckDB execution by setting `quack.execution` to `false`.
