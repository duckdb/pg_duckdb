...
-- NOTE: JSON_EXISTS is tested separately in json_exists_duckdb, because its
-- output differs between Postgres versions and keeping it here would require a
-- separate expected output file for this whole (large) test.
