...
SELECT * FROM duckdb.query($$ SELECT '4714-11-24 (BC) 00:00:00'::timestamp as timestamp $$);
SELECT * FROM duckdb.query($$ SELECT '4714-11-23 (BC) 23:59:59'::timestamp as timestamp $$);  -- out of range
SELECT * FROM duckdb.query($$ SELECT '294246-12-31 23:59:59'::timestamp as timestamp $$);
SELECT * FROM duckdb.query($$ SELECT '294247-01-01 00:00:00'::timestamp as timestamp $$);  -- out of range
...
SELECT * FROM duckdb.query($$ SELECT '4714-11-24 (BC) 00:00:00'::timestamp_ms as timestamp_ms $$);
SELECT * FROM duckdb.query($$ SELECT '4714-11-23 (BC) 23:59:59'::timestamp_ms as timestamp_ms $$);  -- out of range
SELECT * FROM duckdb.query($$ SELECT '294246-12-31 23:59:59'::timestamp_ms as timestamp_ms $$);
SELECT * FROM duckdb.query($$ SELECT '294247-01-01 00:00:00'::timestamp_ms as timestamp_ms $$);  -- out of range
